  ...
  Widget _selectStep() => Column(mainAxisSize: MainAxisSize.min, children: [
    ...
    Container(
      ...
      child: Column(children: [
        const Icon(Icons.table_chart_outlined, size: 40, color: AppTheme.textSecondary),
        const SizedBox(height: 12),
        const Text('Select an Excel (.xlsx) or CSV file',
            style: TextStyle(fontWeight: FontWeight.w500)),
        const SizedBox(height: 10),
        const Text('Supported column names (case-insensitive):',
        ...
        const SizedBox(height: 6),
        const Text('Required: JID, Prisoner Name, Admission Date',
            style: TextStyle(fontSize: 11, color: AppTheme.textDisabled)),
        const SizedBox(height: 4),
        const Text('Date format: DD-MM-YYYY or YYYY-MM-DD',
            style: TextStyle(fontSize: 11, color: AppTheme.textDisabled)),
      ]),
    ),
    const SizedBox(height: 16),
